        ...
        static void Main(string[] args)
        {
            ...
            using (StreamReader sr = new StreamReader(filePath))
            {
                ...
                while ((usuario = sr.ReadLine()) != null)
                {
                    ...
                    Conta conta = new Conta(dados[1], dados[0], dados[2]);
                ...
                if (login)
                {
                    ...
                    if (operação == "1")
                    {
                        ...
                        if (Senha != "esqueci")
                        {
                            ...
                            if (login == true) { Console.WriteLine("Email ou Senha Incorretos"); }
                        }
                        else
                        {
                            string remetenteEmail = "TrabalhoMosca@outlook.com";
                            string remetenteSenha = "TrabalhodoMosca";
                            ...
                            try
                            {
                                using (SmtpClient smtpClient = new SmtpClient(smtpHost, smtpPort))
                                {
                                    ...
                                    message.Body = $"A senha é: Chupinga";
                                    ...
                                    try
                                    {
                                        ...
                                        {
                                            writer.WriteLine($"{Hash("Nome")} {Hash(Email)} {Hash("Chupinga")}");
                                        }
                                    }
                                    catch (Exception ex)
                                    {
                                    ...
                                    Conta conta = new Conta(Hash("Nome"), Hash(Email), Hash("Chupinga"));
                                    Listaconta.Add(conta);
                    ...
                    else if (operação == "2")
                    {
                        ...
                        Conta conta = new Conta(HashNome, HashEmail, HashSenha);
                        Listaconta.Add(conta);
